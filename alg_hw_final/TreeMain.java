...
//        tree.dfs(integer -> dfsOrderItems.add(integer));
        ...
        Homework hw = new Homework(tree);
        System.out.println("Последнее значение: " + hw.findLast());
        System.out.println("Количество листьев: " + hw.countLeafs(hw.getOurTree().getRoot()));
    }
